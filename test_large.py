...
parser.add_argument('--model_type',type=str,default='DeflareMamba')
...
def demo(images_path,output_path,model_type,output_ch,pretrain_dir,flare7kpp_flag):
    ...
    if model_type=='DeflareMamba':
        model=DeflareMamba(img_size=512,in_chans=3,output_ch=6,img_range=1.,d_state=10,depths=[1,2,4, 4, 4,2,1],embed_dim=40,mlp_ratio=1.).cuda()
